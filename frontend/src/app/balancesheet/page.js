          ...
          <div style={{ minHeight: "420px" }}>
            {data.liabilities.length === 0? <p style={{ padding: "15px", opacity: 0.6 }}>No Liabilities</p> :
              data.liabilities.map((l, i) => (
                <div key={i} onClick={() => handleLedgerClick(l)} style={{ display: "flex", justifyContent: "space-between", padding: "12px 15px", borderBottom: "1px solid rgba(255,255,255,0.08)", fontSize: "14px", background: l.isPnl? "rgba(34,211,238,0.15)" : "transparent", cursor : "pointer" }}>
        ...
        <div style={{ flex: 1, minWidth: "300px", border: "1.5px solid #60a5fa", borderRadius: "12px", overflow: "hidden", background: "#131d42" }}>
          ...
          <div style={{ minHeight: "420px" }}>
            {data.assets.length === 0? <p style={{ padding: "15px", opacity: 0.6 }}>No Assets</p> :
              data.assets.map((a, i) => (
                <div key={i} onClick={() => handleLedgerClick(a)} style={{ display: "flex", justifyContent: "space-between", padding: "12px 15px", borderBottom: "1px solid rgba(255,255,255,0.08)", fontSize: "14px", background: a.isPnl? "rgba(251,146,60,0.12)" : "transparent", cursor: "pointer" }}>
